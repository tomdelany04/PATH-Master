...
<li>Its aim to provide patient-centered estimates of outcome risks with versus without the intervention.</li>
</ul>
:::
:::
...
<li>Mitigates certain limitations of subgroup analyses (Type I error, low power).</li>
</ul>
:::
:::
:::
...
trial_summary %>%
  ...
  cols_label(
    ...
    VITAL = md("[VITAL](https://www.nature.com/articles/s41430-022-01244-w/)")
  ) %>%
  tab_options(
...
<p><strong>Beneficial overall effect:</strong> aspirin  significantly reduced death or non-fatal recurrent stroke <strong>(OR 0.95)</strong>.</p>
:::
:::
...
<p><strong>Beneficial overall effect:</strong> 30-day mortality was significantly lower with accelerated tPA than with streptokinase <strong>(OR 0.85)</strong>.</p>
:::
:::
...
<p><strong>No clear overall difference:</strong> vitamin D/Omega-3 supplementation did not significantly lower cancer compared with placebo <strong>(HR 0.96/0.92).</strong></p>
:::
:::
:::

::: {.info-box .fragment style="margin-top:0.38rem; padding:0.42rem 0.72rem; font-size:0.62em; line-height:1.06;"}
<strong>PATH recommendation:</strong> Risk-modeling approaches should generally be applied in presence of an overall treatment effect, and interpreted more cautiously when there is not.
:::
...
## Relative vs Absolute Benefit {.path-slide}

::: {.columns .path-grid}
::: {.column width="50%"}
::: {.path-card}
<div class="path-badge">R</div>
<h3>Relative Effects</h3>
<p>Relative effects describe how treatment changes outcomes proportionally, typically through odds ratios or hazard ratios.</p>
<ul>
<li>In PATH, they help assess whether treatment benefit is broadly consistent across baseline risk strata.</li>
<li>In this presentation and in the report, we show these using PATH-aligned forest plots.</li>
</ul>
:::
:::
...
<h3>Absolute Effects</h3>
<p>Absolute effects describe the change in event probability itself, so they are often more directly interpretable for patients and practice.</p>
<ul>
<li>In PATH, they show how treatment benefit may increase or decrease across baseline risk even when relative effects look stable.</li>
<li>We present these as absolute treatment-benefit plots here and in the final report.</li>
</ul>
:::
:::
:::
...
::: {.info-box style="padding:0.35rem 0.6rem;"}
<ul>
...
## Absolute Benefit Results {.results-panel-slide .absolute-results-panel-slide}

::: {.columns .results-panel-grid}
::: {.column width="50%"}
::: {.results-panel-card}
<h3>IST</h3>
```{r, echo=FALSE, message=FALSE, warning=FALSE, out.width='100%', fig.width=9.6, fig.height=6.4}
...
## VITAL Absolute Benefit Results {.results-panel-slide .absolute-results-panel-slide}
...
<ul>
<li>PATH is most feasible in large, well-characterised datasets where baseline risk and subgroup differences can be estimated reliably.</li>
<li>Trials of this size being conducted and available to analyse is a potential barrier.</li>
</ul>
::: 
:::
...
<ul>
<li>The usefulness of PATH also depends on the trial's overall treatment effect.</li> 
<li>When weak/ not evident, detection of HTE may remain difficult even in strong datasets.</li>
</ul>
:::
:::
...
<ul>
<li>Implementation may depend on future reporting expectations from major regulators.</li>
<li>There is currently no routine regulatory requirement for PATH analyses.</li>
</ul>
:::
:::
:::
