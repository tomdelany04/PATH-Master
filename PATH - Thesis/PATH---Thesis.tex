...
\includegraphics[width=17.44in]{PATH_workflow_io}

\subsection{Monte Carlo simulations for
examining}\label{monte-carlo-simulations-for-examining}

\subsubsection{Data Generating Process}\label{data-generating-process}

For each individual (n = 5000), 3 baseline covariates from independant
normal distributions were generated.
...
\pandocbounded{\includegraphics[keepaspectratio]{PATH---Thesis_files/figure-latex/unnamed-chunk-3-1.pdf}}
\# Discussion

\subsection{Regulatory Implications}\label{regulatory-implications}
