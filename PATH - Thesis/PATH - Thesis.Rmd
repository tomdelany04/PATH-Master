...
```{r mc-flow, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', fig.pos='!htbp', out.width='100%', fig.cap='Workflow of the Monte Carlo simulation study used to assess how variation in model dimension and sample size influences empirical Type I error in the null treatment-by-risk interaction setting. This schematic summarises the simulation design and analysis pipeline.'}
