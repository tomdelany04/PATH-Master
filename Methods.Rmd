...
The PATH approach was implemented in the IST-1, GUSTO-1, DIG and VITAL trials as outlined in Figure \ref{fig:path-workflow}. Following data ingestion and exploratory analyses, risk modelling was performed using pre-specified, adjusted baseline models for each trial, as described in Sections 2.1-2.4. These risk models were blinded from treatment allocation and employed to assess the relationship between baseline risk distributions and treatment effect on an absolute scale, in line with recommendations from Kent and Colleagues [@kentPredictiveApproachesTreatment2020].
...
....
Need another 2-3 paragraphs to flesh this out,
IST trial still needs to be finalised
