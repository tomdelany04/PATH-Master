...
keywords:
  ...
  - ADEMP - Aim, Data-generating Mechanism, Estimand, Methods, Performance Measure
  - OR - Odds Ratio
  - RR - Relative Risk
  - HR - Hazard Ratio
  ...
  - ICH E9(R1) - International Council for Harmonisation E9 Guideline, Revision 1
  - SYSBP - Systolic Blood Pressure
  - PREVMI - Previous Myocardial Infarction
  - RCONSC - Randomization/Baseline Consciousness
  - RSBP - Randomization/Baseline Systolic Blood Pressure
  - RATRIAL - Randomization/Baseline Atrial Fibrillation
  - RDELAY - Randomization/Baseline Treatment Delay
  - RSLEEP - Sleep Status at Stroke Onset
  - RVISINF - Visible Infarction on Computed Tomography
  - RDEF1–RDEF5 - Neurological Deficit Variables 1 to 5
bibliography:
...
```{r measures, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', out.width='80%', fig.cap='Measures of original cohort of 4063 men for "Approximate Average", Daniels, 1952'}
...
```{r path-workflow, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', out.width='80%', fig.cap='Overview of the empirical PATH workflow used across the trial analyses.'}
...
```{r ist-relative-effects, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', out.width='95%', fig.cap='PATH-compatible forest plots showing the relative treatment effect of aspirin compared with control across baseline-risk quartiles and conventional one-variable-at-a-time subgroups in IST-I. Panels show quartiles derived from the logistic regression and random forest baseline-risk models, respectively.'}
knitr::include_graphics(c(
...
```{r ist-absolute-effects, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', fig.width=7, fig.height=4.2, out.width='88%', fig.cap='Absolute benefit of aspirin across predicted baseline risk in IST-I. Panels show the logistic regression and random forest baseline-risk models, respectively.'}
library(ggplot2)
...
\end{equation}
```{r dig-relative-effect, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', out.width='95%', fig.cap='PATH-compatible forest plot showing the relative treatment effect of digoxin compared with placebo across baseline-risk quartiles and conventional one-variable-at-a-time subgroups in the DIG trial.'}
knitr::include_graphics("DIG_report_forest.png")
```

```{r dig-absolute-effect, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', fig.width=7, fig.height=4.2, out.width='88%', fig.cap='Absolute benefit of digoxin across predicted baseline mortality risk in the DIG trial.'}
library(ggplot2)
...
```{r vital-relative-effects, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', out.width='95%', fig.cap='PATH-compatible forest plots showing absolute risk differences for omega-3 and vitamin D supplementation across baseline-risk quartiles and conventional subgroups in VITAL.'}
knitr::include_graphics(c(
...
```{r vital-absolute-effects, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', out.width='88%', fig.cap='Absolute benefit of omega-3 and vitamin D supplementation across predicted 5-year baseline risk of cardiovascular death in VITAL.'}
knitr::include_graphics(c(
  "VITAL_plot_omg.png",
  "VITAL_plot_Vit.png"
))
...
```{r mc-flow, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', out.width='100%', fig.cap='Workflow of the Monte Carlo simulation study used to assess how variation in model dimension and sample size influences empirical Type I error in the null treatment-by-risk interaction setting.'}
...
```{r mc-type1-surface, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', out.width='92%', fig.cap='Empirical Type I error surface for the likelihood ratio test of a treatment-by-risk interaction across simulated sample sizes and numbers of prognostic covariates.'}
...
A further consideration is, that when met, the implementation of the PATH approach alongside prospective clinical trials or within their protocols may be seen as an additional analytical burden on biostatisticians that does not

## Limitations

One-two paragraph is all
Talk about data accessibility, time constraints, extension if this project has a longer time scope etc

# Conclusion

one larger paragraph wrap up on limits, approach at its best and worst, next steps etc...
....
plans

probably an update of the MC workflow we have in draw.io, still pretty relevant and will fill half a pg, Maybe a graphical abstract idk. Could use the ADEMP figure we have from morris and colleague either. Fix broken figure refs etc...


Use Readme, for the Github Repository - identify elements of the code, that allow for reproduction of the report.

Notes
Discussion is More expansive
