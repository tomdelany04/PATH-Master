...
<li>This slidedeck was built in ![](clipboard-3280506532.png){height="1.2em"} using ![](quarto.png){height="1.2em"}</li>

<li>Our GitHub repository is linked in the footer ![](GitHub_Invertocat_Black.png){height="1.2em"}</li>
...
:::: {.column width="50%"}
::: {.outcome-card .fragment}
![](Digitalis2-1.jpg){.outcome-image}
...
![](DIG_presn_forest.png){width="100%"}
:::
::::
...
![](VITAL_presn_forest_omega.png){width="100%"}
:::
::::
...
![](VITAL_presn_forest_vitd.png){width="100%"}
:::
::::
:::::::
