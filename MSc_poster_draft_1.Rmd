...
```{r morefigs, out.width='80%', echo=FALSE, fig.cap='Baseline Risk', fig.height=4}
knitr::include_graphics("Baseline_Mortality_risk_by_risk_group.png") 

```

```{r morefigs, out.width='80%', echo=FALSE, fig.cap='Figure 2.1: Overall mortality rate across the study', fig.height=4}
overall_mor <- ggplot(dig.df, 
