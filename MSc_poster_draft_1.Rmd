...
`GUSTO` = c(41021, "Accelerated tPA vs streptokinase (± heparin)", "1989–1993", "Open-Label", "30 days", "15 Countries", "30-day mortality"),
`DIG` = c(6800, "Digoxin vs placebo", "1991–1995", "Double-blind, placebo-controlled", "37 Months (mean)", "USA", "All-cause mortality")
)
