---
title: Predictive Approaches to Treatment Effect Heterogeneity in heart failure and Stroke Patients
author:
  - name: Tom Delany
  - name: Misgana Ojamo
    affil: 1
...
Above is a Forest Plot which display the PATH (risk-based) subgroups alongside traditional subgroups (Age, Sex, Location of MI). 
