...
# Load the fitted model (this RDS already contains the data in res2$data)
res2 <- readRDS("dig_forest_baseline_risk_model.rds")
data.subgroups <- res2$data
...
# Refit so the plot uses updated labels (and keep everything self-contained)
...
# Headers
text(-1.2, 18, "DIG Trial Subgroups", font=2, adj=0, cex=.9)
