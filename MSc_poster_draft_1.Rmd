...
library(metafor) #Forest Plots
library(Hmisc) #Risk/Benefit Plots
library(splines) #Risk/Benefit Plots
library(dplyr) 
...
#Basic Dataframe for descriptive Plots
...
```{r fig-table1, fig.cap="Key subgroups and their characteristics for DIG and GUSTO. MI - Myocardial Infarction, NYHA - New York Heart Association, EJF_PER - Ejection fraction (percent)", echo = F, message = FALSE, warning = FALSE, out.width='100%', fig.align = "center"}
#Gusto and DIG tables (Create table - Make gt - Change styling - combine and output as PNG)
...
```{r DIG-fig-forest, echo=FALSE, message = FALSE, warning = FALSE, fig.cap="DIG Trial, Forest plot of treatment heterogeneity. Points represent odds ratios and horizontal lines indicate 95% confidence intervals.", out.width="100%", fig.align="center"}
...
```{r fig-forest, echo=FALSE, message = FALSE, warning = FALSE, fig.cap="GUSTO Trial. Forest plot of treatment heterogeneity. Points represent odds ratios and horizontal lines indicate 95% confidence intervals; the vertical line denotes no effect (OR = 1).", out.width="100%", fig.align="center"}
...
• The histogram at the bottom of the plot shows substantial **heterogeneity in baseline risk**, concentrated at low risk values.

```{r fig-proportional, echo=FALSE, message = FALSE, warning= FALSE, fig.cap="Absolute treatment benefit increases with baseline risk across estimates in the GUSTO trial.", out.width="100%", fig.align="center"}
...
lines(x=pack2$xp, y = pack2$p2, type='l', lty=2, lwd=3, col = "red") #Linear Spline 2 df
...
legend("topleft",
lty=c(1, 2, NA), pch=c(NA,NA, 1), lwd=c(3, 3, 2),
bty="n", col=c("#84003d","red", "blue"), cex=1.2,
legend=c("Expected with proportional effect","Spline Smoothing, 2df", "Grouped patients"))
